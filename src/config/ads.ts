 ...
 *
 *   116  home-inline      incontent_6  creado en Ezoic, hoy sin usar
...
export const EZOIC_PLACEHOLDERS = {
  // La home no lleva publicidad: es la página a la que se llega con una
  // emergencia. El placeholder 116 existe en Ezoic por si se reactiva, pero
  // aquí queda en null y además la home pasa ads={false} al layout.
  'home-inline': null,
  'zona-inline': 117,
  'clinica-inline': 118,
  'clinica-sidebar': 119,
