...
El catálogo tiene inconsistencias heredadas; inventariar el conjunto real y resolverlas sin fabricar evidencia ni horarios.

## Referencia y secuencia

- Clave: I03; prioridad **P1**.
- Dependencias: [#28](https://github.com/Gunz-cop/Vet24-cr/issues/28).
...
Posee saneamiento del contenido; reutiliza validadores #28. No desarrolla otro parser ni despliega.

## Tareas

- [ ] Usar herramientas de #28 para inventario dinámico y revisar baseline de deuda.
- [ ] Investigar registros afectados y actualizar ficha/evidencia por sucursal preservando IDs/slugs.
- [ ] Representar unknown/pendiente donde falten fuentes, retirando afirmaciones positivas injustificadas.
- [ ] Retirar entradas de deuda conforme se resuelven y validar colección completa.

## Criterios de aceptación

- [ ] docs/admin/data-debt.json termina con entries vacío y validate:clinics total pasa sin exenciones.
- [ ] No se presupone que las 112 fichas estén rotas ni se fija ese número en tests; inventario documenta hallazgos reales.
- [ ] Ningún arreglo inventa horario, geolocalización, llamada o presencia nocturna; cambio concurrente invalida la exención.
- [ ] Se preserva historial e identidad; borrador sin coordenadas queda fuera de mapa/GPS según contrato.
